...
Popper ist der Spruch zugeschrieben "Man sage ungewöhnliche Dinge mit gewöhnlichen Worten". Das Gegenteil davon ist *Schwafeln* (Geschwurbel). Das Gegenteil von Schwafeln ist Präzision (im Formulieren).

:::{#def-schwafel}
### Schwafel (Geschwurbel)
Schafeln ist eine wortreiche und/oder wenig präzise Darstellung mit wenig Information. $\square$
:::
...
2. Beispiel
  ...
  - Besser: "Ein Überblick zu XYZ muss Befunde aux X, Y und Z vereinen."
...
8. Beispiel:
  ...
  - Besser: Schwächen der Studie aufzählens
...
Neben MS Word oder Libe Office kann Google Docs eine sinnvolle Alternative sein, um ihre Arbeit zu verschriftlichen.
