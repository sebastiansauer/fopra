...
#### Analyse
- Verwendete Analyse-Software (idealerweise mit Versionsnummer) wie R 
- Software, die zur Reproduzierbarkeit nicht von Relevaz ist, braucht nicht angegeben zu werden (z.B. Word oder RStudio)
- Kurze Skizzierung des statistischen Vorgehens (wie z.B. Bayes-Methoden auf Basis von Stan)
