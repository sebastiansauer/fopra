...
- *Rekrutierungsweise* und Teilnahmemotivation der Versuchsteilnehmer


#### Versuchsmaterial 
- Verwendete *Messinstrumente* (z.B. Fragebogen inkl. zentrale Maße der Güte)
...
#### Analyse
- Verwendete Analyse-*Software* (idealerweise mit Versionsnummer) wie R^[RStudio ist nur eine Benutzeroberfläche und daher irrelevant für die Ergebnisse)
...
Stattdessen sind Konfidenzintervalle ausreichen (die die Information des p-Werts im Übrigen abdecken).
