...
- Die Studentis können eigenständig einige Arten von quantitativen psychologischen *Studien* in allen wesentlichen Schritten *durchführen*,f d.h. planen, erheben, auswerten, interpretieren und zusammenschreiben.
...
Um eine PDF-Version eines Kapitels zu erhalten,
können Sie im Browser die Druckfunktion nutzen (Strg-P).
Wählen Sie dort "PDF" als Ziel.
...
{{< include Interna/Hinweise-Lernhilfen.qmd >}}
...
{{< include Interna/Hinweise-Didaktik.qmd >}}
...
{{< include Interna/Hinweise-Unterricht.qmd >}}
