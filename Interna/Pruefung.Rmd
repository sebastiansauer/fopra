...
2. Gegenstand der Seminararbeit ist die *Dokumentation aller Phasen der Studie* des jeweiligen Forschungsteams. Es handelt sich also um eine Gruppenarbeit. Einzelarbeiten sind grundsätzlich nicht zulässig.
...
4. *Formale Anforderungen* an die Seminararbeit:
    - Der Umfang der Arbeit umfasst 6000 Wörter (im Hauptteil).
    - Die Methoden des wissenschaftlichen Arbeiten in Recherche, Zitat und Darstellung werden angewandt.
Anwendung der Methoden quantitativer Datenanalyse
    - Textsatz und Gestaltung der Seminararbeit orientieren sich an dem bereitgestellten Leitfaden.
    - Gestaltungsaspekte, die nicht im bereitgestellten Leitfaden aufgeführt sind, sind nach den Vorgaben der APA (neueste Version) anzulegen.
    - Die Arbeit kann in deutscher oder englischer Sprache eingereicht werden.
...
6. Die *Anzahl der Wörte*r des Hauptteils ist auf dem Deckblatt anzugeben.
...
14. *Open Science*: Reichen Sie die Rohdaten und ggf. Syntax (elektronisch) ein. Verweisen Sie im Anhang auf eine Datei, die Sie hochladen, in der die entsprechenden Informationen zu finden sind.

15. Das Thema muss einen d*irekten empirisch-psychologischen Bezug* haben; die Forschungsfrage muss psychologisch relevante Aspekte adressieren.
...
2. Nichteinhaltung der Regeln bzw. der Hinweise kann zum Durchfallen oder schlechterer Note führen.
