...
In @tbl-checkliste-datenanalyse sehen Sie im Überblick die Schritte, die in vielen Fällen sinnvoll sind, um Daten auf einem guten Niveau auszuwerten.
...
:Checkliste zur Datenanalyse {#tbl-checkliste-datenanalyse}
...
Das Kursbuch [Statistik1](https://statistik1.netlify.app/) beinhaltet einen Überblick über Datenaufbereitung und -visualisierung  sowie Modellierung mit dem linearen Modell, alles mit R.
...
![Inferenzstatistik schätzt die (Un-)Genauigkeit der Kennwerte der Deskriptivstatistik](img/desk-inf-fans.jpg){#fig-inf2 width=70% fig-align="center"}
...
die ein Sinnbild von statistischen Modellen wiedergibt.
...
Übersetzen wir @lst-desk1 vom Englischen ins Deutsche:
...
@tbl-typ-fehler-statistik zeigt häufige Fehler bei statistischen Auswertungen in studentischen Arbeiten.
...
: Typische Fehler in statistischen Auswertungen {#tbl-typ-fehler-statistik}
...
Auf dem [Datenwerk](https://sebastiansauer.github.io/datenwerk/) finden Sie eine Anzahl an Aufgaben zum Thema Datenanalyse.
Schauen Sie sich mal die folgenden Tags an:

- [eda](https://sebastiansauer.github.io/datenwerk/#category=eda)



## Fallstudien

Fallstudien zur explorativen Datenanalyse (EDA; d.h. deskriptive Statistik und Datenvisualisierung) finden Sie z.B. im [Datenwerk](https://sebastiansauer.github.io/):

- [flights-yacsda-eda](https://sebastiansauer.github.io/posts/flights-yacsda-eda/)
- [oecd-yacsda](https://sebastiansauer.github.io/posts/oecd-yacsda/)
- [smartphone1](https://sebastiansauer.github.io/posts/smartphone1/)
