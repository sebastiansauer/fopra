...
Ein Teil der Dokumentation ist ein Codebook. Ein Codebook erläutert die Namen der Variablen in Ihrer (Roh-)Datentabelle, s. @fig-codebook.
...
[Hier](https://statistik1.netlify.app/) finden Sie einen Überblick zu den Grundlagen der Datenanalyse mit einem Fokus auf die Regressionsanalyse.
...
3. Modellierung
    ...
    4. Nullhypothesen testen (ROPE)
    5. Modellgüte berichten (R-Quadrat)
