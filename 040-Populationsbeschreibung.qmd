...
| **$R^2$**                              |  0.01 | 0.06–0.09 | 0.14–0.25 |
| **$f^2$ (Cohen)**                      |  0.02 |      0.15 |      0.35 |
...
Das R-Paket [`effectsize`](https://easystats.github.io/see/articles/effectsize.html), Teil von `easystats`, bietet Hilfen zur Klassifizierung von Effektstärken.
