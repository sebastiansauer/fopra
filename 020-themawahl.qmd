...
Was Sie brauchenk ist eine präzise Forschungsfrage.
...
Bei "geschützten" (paywalled) Artikeln ist diese nur mit Bezahlzugang möglich.
...
| 11    | [SciSpace](https://scispace.com/)                                         | ja      | ?                                 | 200M+   |
...
:::callout-tip
### Tools für Notizen
Es gibt (IT-)Tools, die Sie beim Notizen machen unterstützen, etwa [Notion](https://www.notion.so/product/ai), [Zotero](https://www.zotero.org/),  [Zettelkasten](https://zettelkasten.de/introduction/), [notion](https://www.notion.so/help/guides/category/ai) oder schöne Notizbücher. $\square$
:::
...
:::callout-caution
Beachten Sie Datenschutz und Urheberrechte, wenn Sie Texte wie Fachartikel an Dritte weitergeben. $\square$
:::
...
Hypothesen beziehen sich nicht auf Stichproben, sondern auf Populationen (Grundgesamtheiten), da die Daten einer Stichproben auf der Hand liegen, also bekannt sind. Für die Stichprobe gibt es keine Ungewissheit. Aber für die Population schon.
