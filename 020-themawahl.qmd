...
Sogenannte "Abläufe" wie die Wahl des Themas einer Forschungsarbeit, die Literaturrecherche oder das Schreiben sind in Wahrheit gar keine Abläufe. Es sind eher Kreise, da man die gleichen Tätigkeiten öfters wiederholt.
Optimistischer ausgedrückt, sind es weder Abläufe noch Kreise, sondern Spiralen, s. @fig-spirale, da sich die Tätigkeiten zwar wiederholen, aber auf höherem oder verfeinertem Niveau.


@fig-litsearch stellt die einzelnen Schritte der Literaturrechere im Überblick dar.

```{mermaid}
%%| fig-cap: Der Ablauf der Literaturrecherche
%%| label: fig-litsearch
flowchart LR
Suchen-->Screenen-->Sammeln-->Lesen-->Extrahieren
```
...
:::{#def-litsearch}
### Literaturrecherche
Die Literaturrecherche ist ein Ablauf, also eine zusammenhänge Folge mehrere Tätigkeitsschitte, mit dem Ziel ein Literaturwerk (kurz: Werk) oder mehrere für die Forschungsfrage geeignete Werke zu finden. $\square$
:::

1. *Suchen* ist das Ausfindigmachen geeigneter Literatur. Dazu sucht man meist in einschlägigen wissenschaftlichen Literatur-Datenbanken wie z.B. Google Scholar.
...
2. Im nächsten Schritt, *Screenen*, sind zumeist die Open-Access-Elemente am wichtigsten, damit man einschätzen kann, ob das Werk geeignet ist. Der Volltext ist an dieser Stelle nicht (unbedingt) nötig.

3. Geeignete Werke *sammelt* man in einer Liste, z.b. via dem Literaturprogramm Zotero. Dabei werden pro Werk die Zitierinformationen festgehalten.

4. Jetzt folgt das *Lesen*^[Ein eigener Ablauf mit mehereren Schritten] eines geeigneten Werks. 

5. Zentrale Inhalte *extrahiert* man aus dem Werk und hält sie an geeigneter Stelle fest, z.B. als Tag oder Notiz in Zotero.
...
Geeignete (IT-)Werkzeuge für diese Schritte sind in @fig-litsearch-tools dargestellt.
...
```{mermaid}
%%| fig-cap: Der Ablauf der Literaturrecherche
%%| label: fig-litsearch-tools
flowchart LR
  subgraph S[Suchen]
    Suchen --- litdb[Literatur-Datenbank]
  end
  subgraph Sc[Screenen]
    Screenen --- lt1[Lesetechnik]
  end
  subgraph Sa[Sammeln]
    Sammeln --- z1[Literatur-Software]
  end
  subgraph Le[Lesen]
    Lesen --- lt2[Lesetechnik]
  end
  subgraph E[Extrahieren]
    Extrahieren --- Notizen
  end
...
Die Anzahl der Suchmaschinen bzw. Datenbanken bzw. (AI-)Suchdienste wächst und schwankt, so dass es schwierig ist, einen umfassenden Überblick zu geben. @tbl-suchdienste versucht einen Überblick zu geben.
...
| 2   	| [Web of Science](https://access.clarivate.com)                          	| nein  	| Clarivate                       	| 136M   	|
| 3   	| [Scopus](https://www.scopus.com/)                                       	| nein  	| Elsevier                        	| 82M    	|
| 4   	| [Base](https://www.base-search.net/)                                    	| ja    	| Bielefeld University            	| 227M   	|
| 5   	| [Core](https://core.ac.uk/)                                             	| ja    	| CORE (non-profit)               	| 136M   	|
| 6   	| [Semantic Scholar](https://core.ac.uk/https://www.semanticscholar.org/) 	| ja    	| Allen Institute for AI          	| 200M   	|
| 7   	| [Refseek](https://www.refseek.com/)                                     	| ja    	| refseek?                        	| 1000M  	|
| 8   	| [elicit](https://elicit.com/)                                           	| ja    	| Ought/Elicit (non-profit?)      	| 200M   	|
| 9   	| [Research Gate](https://www.researchgate.net/)                          	| ja    	| Research Gate (?)               	| 160M?  	|
| 10  	| [Perplexity](https://www.perplexity.ai/)                                	| ja    	| Perplexity AI (Google Spin-Off) 	| 200M   	|

: Suchdienste für wissenschaftliche Werke {#tbl-suchdienste}
...
3. 🙅‍♀️   Der Volltext ist nicht notwendig zugänglich
...
Laut @ward_brain_2017 verringert die *bloße Anwesenheit* eines Handies o.Ä. auf Ihrem Schreibtisch oder in Ihrer Ihren IQ.
Wenn Sie arbeiten, sollten Sie sich daher vornehmen: "Ich werde jetzt konzentriert arbeiten und mich nicht ablenken lassen".
Schalten Sie Ihr Handy aus und stellen Sie sicher, dass Sie nicht gestört werden.
:::

:::callout-tip
### Tools für Notizen
Es gibt (IT-)Tools, die Sie beim Notizen machen unterstützen, etwa [Notion](https://www.notion.so/product/ai), [Zotero](https://www.zotero.org/),  [Zettelkasten](https://zettelkasten.de/introduction/) oder schöne Notizbücher. $\square$
:::
...
Andere Dienste, wie [ChatPDF](https://www.chatpdf.com/), erlauben das Hochladen von PDF-Dokumenten und der Dienst liefert eine Zusammenfassung.

:::callout-caution
Beachten Sie Datenschutz und Urheberrechte, wenn Sie Fachartikel an Dritte weitergeben. $\square$
:::
...
"Ambiguitätstoleranz A und Frustrationsschwelle F hängen (positiv) zusammen"^[Wenn man behauptet, dass zwei Dinge zusammenhängen, so meint man oft implizit, dass sie gleichsinnig, also positiv zusammenhängen.] 
oder "Der Zusammenhang von Trait-Achtsamkeit und Stresslevel wird über die affektiven Reaktivität teilvermittelt". 
Beachten Sie, dass sich Sachhypothesen je nachdem wie sie formuliert sind, in ihrer Exaktheit unterscheiden können.

:::{.callout-important}
Je präziser eine Hypothese formuliert ist (unter sonst gleichen Bedingungen^[das nennt man auch "[ceteris paribus](https://de.wikipedia.org/wiki/Ceteris_paribus)"]), desto besser ist die Hypothese.$\square$
:::
...
- $\beta_1 > 0$: "Der Regressionskoeffizient 1 ist positiv". Das zugrundeliegende Regressionsmodell muss an anderer Stelle definiert sein.
...
Eine totale Sonnenfinsternis für einen bestimmten Tag und einem bestimmten Ort vorherzusagen, ist eine unpräzise Hypothese. 
Man spricht auch von einem geringem empirischen Gehalt.
...
Synonym: Gruppe 1 hat einen höheren Mittelwert als Gruppe 2. In mathematischer Notation: X1 > X2.
