...
2. Gegenstand der Arbeit ist die *Dokumentation aller Phasen der Studie* des jeweiligen Forschungsteams. 


### Formale Anfordungen 

1. Der Umfang der Arbeit umfasst im *Hauptteil* *6000* Wörter bei Gruppenarbeiten und *4000* Wörter ein Einzelarbeiten, plus/minus 10%. *"Hauptteil"* ist definiert als der *gesamte Text* von (Beginn der) Einführung bis (zum Ende der) Diskussion (ein Diagramm als solches zählt nicht als Text). Geben Sie die Wortzahl Ihrer Arbeit an geeigneter Stelle an (Anhang).


4. Textsatz und (gestalterische) *Formatierung* der Arbeit orientieren sich an den schriftlich bereitgestellten Hinweisen (z.B. im Skript).

5. *Übrige Gestaltungsaspekte*, die nicht im bereitgestellten Leitfaden aufgeführt sind, sind nach den Vorgaben der *APA* (neueste Version) anzulegen.
...
7. Wenn die Prüfung aus einer schriftlichen Arbeit besteht oder eine Seminarleistung beinhaltet, ist diese *nur online* über das bereitgestellte System, nicht ausgedruckt einzureichen.
...
26. Sie können die Arbeit entweder in einem *paginierten* Format schreiben (z.B. Word-Dokument) oder in einem *nicht-paginierten* Format (z.B. HTML-Dokument mit Quarto).

27. Eine Arbeit zählt nur dann als (erfolgreich) eingericht, wenn Sie *formal korrekt eingereicht* wurde, insbesondere sind Fristen und Abgabekanäle (z.B. Moodleseite) zu beachten.

28. Wenn Sie Dateien mit Ihren Prüfungsleistungen einreichen (hochladen), dann benennen Sie sie nach folgendem Muster `nachname1-vorname1-nachname2-vorname2-prüfungsart.endung`, z.B.`sauer-sebastian-projektarbeit.pdf` oder `musterfrau-marina-anhang.zip`.
...
2. Werten Sie mit quantitative Fragestellungen komplett mit *R* aus.
...
1. Bei der Benotung wird die *Kenntnis der Inhalte der Veranstaltung* (inkl. dieses Skripts) vorausgesetzt.
...
Der Anspruch an eine *gute* Arbeit ist wie folgt zu fassen (die Angaben beziehen sich auf Einzelarbeiten; bei Gruppenarbeiten ist der Faktor 2 anzulegen):

- Überwiegende Verwendung von *Literatur hoher Qualität* (Fachartikel, peer-reviewed)
- Ca. *15-20 Quellen* (hoher Qualität) oder mehr im Literaturverzeichnis
- Stichprobengröße (ca.)
  - Experimentell: *Between-Design: 20-30 Fälle*, Within-Design: 20 Fälle
  - Beobachtend: 50-100 Fälle bei Einzelarbeiten
- Designumfang (ca.)
  - Experimentell: 2-3 Variablen
  - Beobachtend: 3-4 Variablen bei Einzelarbeiten
