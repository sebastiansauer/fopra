...
1. Der Umfang der Arbeit umfasst im *Hauptteil* *6000* Wörter bei Gruppenarbeiten und *4000* Wörter ein Einzelarbeiten, plus/minus 10%. *"Hauptteil"* ist definiert als der *gesamte Text* von Einführung bis zum Ende der Diskussion.
...
4. Werten Sie mit quantitative Fragestellungen komplett mit *R* aus.
...
7. Wenn die Prüfung aus einer Seminarbeit besteht oder eine Seminarleistung beinhaltet, ist diese *nur online* über das bereitgestellte System, nicht ausgedruckt einzureichen.

8. Bei der Benotung wird die *Kenntnis der Inhalte der Veranstaltung* (inkl. dieses Skripts) vorausgesetzt.

9. Die *im Unterricht behandelten Methoden*, Verfahren oder Inhalte sind bei der Prüfungsleistung *anzuwenden* sofern passend.
...
25. Für *inferenzstatistische Fragestellungen* sind *Bayes-Methoden* (bevorzugt) oder frequentische Methoden einzusetzen.
