...
@fig-desk-inf-fans illustriert an einem Beispiel den Unterschied zwischen Deskriptiv- und Inferenzstatsistik.
...
## Fallbeispiel: World Happieness Report
...
Sagen wir, wir möchten einen normalverteilten Parameter mit "hinreichender Genauigkeit", $e$ schätzen.


:::{#exm-schaetz1}
### Mittelre Daddelzeit
Sagen wir, um es konkret zu machen, uns interessiert die Zeit, die mittelfränkisch junge Erwachsene pro Tag am Handy verbringen ("mittlere Daddelzeit"). Um uns Tipperei zu sparen, geben wir dieser Variablen den Namen 
$X$.

Aus einer Vor-Untersuchung schätzen wir für die Population den Mittelwert auf $\mu=120$ und die Streuung $\sigma$ der Daddelzeit auf 20 (Minuten).
...
Der Radius $r=b/2$ eines Konfidenzintervalls hier so berechnet werden:
