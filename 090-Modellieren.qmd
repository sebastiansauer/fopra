...
%%| fig-cap: "Ablauf der Studie zur Behaltensleistung y2 in Abhängigkeit der Visualisierungsart V (Within-UV mit zwei Stufen, V.1 und V.2). V.1 und V.2 sind jeweils Interventionen und damit Stufen der UV"
flowchart LR
  V.1 --> y1 --> V.2 --> y2
```
