...
Teilen Sie sich dabei in Gruppen auf; jede Gruppe nutzt eine andere KI:

a. [Custom GPT: AskYourPDF Research Assistant](https://chatgp(t.com/g/g-UfFxTDMxq-askyourpdf-research-assistant)
b. [SciSpace](https://scispace.com/)
c. [Gemini](https://gemini.google.com/app)
d. [ChatPDF](https://www.chatpdf.com/)
e. [Google Notebook LM](https://notebooklm.google.com/) $\square$
:::
...
Vergleichen Sie die folgenden KI-Dienste:

a. [Custom GPT: AskYourPDF Research Assistant](https://chatgpt(t.com/g/g-UfFxTDMxq-askyourpdf-research-assistant)
b. [SciSpace](https://scispace.com/)
c. [Gemini](https://gemini.google.com/app)
d. [ChatPDF](https://www.chatpdf.com/)
e. [Google Notebook LM](https://notebooklm.google.com/)


Schreiben Sie Ihre Erfahrungen auf [dieser Schreibwand](https://padlet.com/profsebastiansauer/tldr-ki-tools-zur-textzusammenfassung-nhsg6h0jozlay9j0) zusammen.
...
primär in Form von testbaren Erklärungen über beobachtbare Phänomne. $\square$
:::
