...
Suchen Sie sich eine Studie aus einem Wissenschaftsmagazin und arbeiten Sie die Kernaspekte heraus. 
...
Da die Phänomene der Welt (Evolution, Gravitation, Liebe, Inflation, Aggression, ...) komplex sind, neigen auch die Erklärungsansätze der Wissenschaft dazu, kompliziert zu sein.
Allerdings sollten die Erklärungsansätze so einfach wie möglich sein (und so komplex wie nötig).
...
Umsetzung: Anfragen wie "Gib eine Liste mit fünf Schlüsselpunkten" oder "Formatiere die Ausgabe als Tabelle mit den Spalten 'Name', 'Datum' und 'Zusammenfassung'" oder "gebe das Ergebnis im JSON Format zurück" führen zu präziseren Ergebnissen.
