...
Eine Bedingung (Gruppe), in der nur ein Treatment als Referenzwert verabreicht wird, nennt man auch Kontrollbegingung (Kontrollgruppe). Häufig ist der Referenzwert "kein Treatment" oder ein Placebo.$\square$
:::
...
Vor und nach der Intervention wird bei jeder Person die Konzentrationsfähigkeit gemessen, s. @fig-between.$\square$.
:::
